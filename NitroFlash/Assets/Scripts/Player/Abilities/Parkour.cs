...
/// <summary>
/// Class containing all the logic for the Parkour ability
/// </summary>
public class Parkour : MonoBehaviour {
	...
	/// <summary>
	/// Checks if player is currently attached to a wall
	/// </summary>
	/// <returns>True if player is holding a wall, false if not</returns>
	...
	/// <summary>
	/// Engages the "Slide" state that lowers friction and boosts the player in their current direction
	/// </summary>
	void Slide(){
	...
	/// <summary>
	/// Lowers the player's view to "Crouched" levels and slows the player down
	/// </summary>
	void Crouch(){
	...
	/// <summary>
	/// Handles resetting the player to the default state when no buttons are pressed
	/// </summary>
	void Stand(){
		playermove.friction = 6;
		playermove.moveSpeed = defaultMoveSpeed ;
	...
	/// <summary>
	/// Checks for a wall to hold nearby based on player input
	/// </summary>
	/// <param name="dir">The direction the player is currently checking (i.e. left/right/forward/backward) </param>
	...
	/// <summary>
	/// Handles moving a player up a ledge once they reach the top of a wall
	/// </summary>
	/// <returns>A Wait to return control to player</returns>
	...
	/// <summary>
	/// Checks if the player can climb the desired ledge
	/// </summary>
	/// <returns>True if there are no obstacles preventing the transition, false otherwise</returns>

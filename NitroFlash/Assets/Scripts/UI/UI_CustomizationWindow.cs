...
/// <summary>
/// This UI class controls all the player customization
/// </summary>
public class UI_CustomizationWindow : MonoBehaviour {
	...
	/// <summary>
	/// Saves the current customization locally
	/// </summary>
	...
	/// <summary>
	/// Initializes the defaults for all customization options
	/// </summary>
	void SetDefaults(){
		if (defaultsLoaded) {
			return;
	...
	/// <summary>
	/// Called when a body color layer is updated
	/// </summary>
	/// <param name="col">The result color</param>
	...
	/// <summary>
	/// Called when a face color layer is updated
	/// </summary>
	/// <param name="col">The result color</param>

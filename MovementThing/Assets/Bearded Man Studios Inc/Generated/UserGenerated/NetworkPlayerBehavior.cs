...
{
	[GeneratedRPC("{\"types\":[[\"int\", \"string\", \"uint\"][\"string\", \"uint\"][\"string\"][][][\"Vector3\", \"Quaternion\", \"string\"][\"string\"][][][\"string\"][\"string\"][\"bool\", \"bool\", \"bool\"][\"int\"][\"bool\"][\"string\", \"uint\"][\"string\", \"uint\"]]")]
	[GeneratedRPCVariableNames("{\"types\":[[\"damage\", \"instigator\", \"instigatorID\"][\"instigator\", \"instigatorID\"][\"killed\"][][][\"position\", \"rotation\", \"instigator\"][\"killed\"][][][\"playerName\"][\"playerNamesJSON\"][\"score\", \"kills\", \"deaths\"][\"amount\"][\"isMidAir\"][\"customizationData\", \"playerID\"][\"customizationData\", \"playerID\"]]")]
